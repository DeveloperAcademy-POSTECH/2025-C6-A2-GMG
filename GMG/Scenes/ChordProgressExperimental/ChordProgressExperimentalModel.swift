...
protocol ChordProgressExperimentalModelStateProtocol {
    var score: Score { get }
    ...
    var segmentSlices: [[ChordProgressExperimentalSegmentSlice]] { get }
}

protocol ChordProgressExperimentalModelActionProtocol: AnyObject {
...
struct ChordProgressExperimentalSegmentSlice: Identifiable {
...
@Observable
final class ChordProgressExperimentalModel:
    ChordProgressExperimentalModelStateProtocol,
    ChordProgressExperimentalModelActionProtocol
{
    ...
    private(set) var segmentSlices: [[ChordProgressExperimentalSegmentSlice]]
    ...
    private func rebuildSegmentSlices() {
        ...
        var newSlices: [[ChordProgressExperimentalSegmentSlice]] = []
    ...
    /// UI에서 사용할 `ChordProgressExperimentalSegmentSlice` 배열로 변환한다.
