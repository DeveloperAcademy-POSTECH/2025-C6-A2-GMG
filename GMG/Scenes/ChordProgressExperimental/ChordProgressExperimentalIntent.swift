...
protocol ChordProgressExperimentalIntentProtocol {
...
final class ChordProgressExperimentalIntent: ChordProgressExperimentalIntentProtocol {
    private weak var model: ChordProgressExperimentalModelActionProtocol?
    ...
    init(
        model: ChordProgressExperimentalModelActionProtocol,
