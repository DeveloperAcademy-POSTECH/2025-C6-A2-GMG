...
struct ChordProgressExperimentalSegmentHandlers {
    let onTapChordCell: (ChordCell, TimeInterval) -> Void
    let onTapChordCandidate: (Chord, ChordCell) -> Void
}

struct ChordProgressExperimentalWaveformHandlers {
...
struct ChordProgressExperimentalSegment: View {
    let index: Int
    let totalDuration: TimeInterval
    let chordSlices: [ChordProgressExperimentalSegmentSlice]
        ...
        VStack(spacing: Spacing.xs) {
            ...
            GeometryReader { proxy in
                ...
                VStack(spacing: Spacing.xs) {
                    ...
                    ChordProgressExperimentalWaveform(
                        width: segmentWidth,
